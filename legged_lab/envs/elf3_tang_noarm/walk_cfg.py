    ...
    undesired_contacts = RewTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_sensor", body_names=[".*_knee_y.*", ".*_hip_z.*", ".*_hip_y.*", ".*_wrist_z.*", "torso_link"]
            ),
            "threshold": 3.0,
        },
    )
...
@configclass
class Elf3TangWalkNoarmAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "walk_elf3_tang_noarm"
    run_name = ""
    logger = "tensorboard"
