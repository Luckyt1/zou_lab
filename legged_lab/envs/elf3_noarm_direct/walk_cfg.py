...
@configclass
class Elf3WalkNoarmDirectFlatEnvCfg:
...
@configclass
class Elf3WalkNoarmDirectAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "walk_noarm_direct"
    run_name = ""
    logger = "tensorboard"
    neptune_project = "walk_noarm_direct"
    wandb_project = "walk_noarm_direct"
    resume = True
    load_run = ".*"
